...
export function Loading(props: PropsLoading): JSX.Element {
  return (
    <LoadingWrap>
      <LoadingEclipse className="loading-eclipse" small={!!props.small}>
        <div />
      </LoadingEclipse>
    </LoadingWrap>
  );
...
const LoadingEclipse = styled.div<PropsLoading>`
  width: 100%;
  height: 100%;
  position: relative;
