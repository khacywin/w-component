...
var Dropdown = require('components/atoms/Dropdown');
...
var SelectListOption = React__default["default"].memo((props) => {
        ...
        if ((!val || val.length === 0) && !props.isMultiple) {
            ...
            return val.map((item, key) => {
                ...
                return item && (React__default["default"].createElement(Item, { key: key },
                    ...
                    React__default["default"].createElement(ButtonAction__default["default"], { action: (e) => {
                            e.preventDefault();
                            e.stopPropagation();
                            handleRemove(item);
                        } },
    ...
    const renderOptions = React.useCallback((listOptions) => {
        const _id = generatedId__default["default"]('select-list');
    ...
    return (React__default["default"].createElement(Dropdown__default["default"], { full: true, clickOut: !props.isMultiple, className: 'w-select-wrap', dropdown_menu: React__default["default"].createElement(SelectLists, { className: 'select-options' },
            props.isSearch && (React__default["default"].createElement(SelectListSearch, { className: 'w-select-options-search' },
                React__default["default"].createElement(Icon__default["default"], { icon: 'i-search' }),
                React__default["default"].createElement("input", { ref: refFormSearch, placeholder: _t__default["default"]('Search ...'), type: 'text', autoFocus: true, onChange: (e) => search(e.target.value) }))),
        ...
        React__default["default"].createElement(SelectListValue, { minHeight: props.isMultiple && 39, className: 'w-select-value' },
            props.value && props.value.length > 0 ? (renderLabel(props.value)) : (React__default["default"].createElement(PlaceHolder, null, _t__default["default"]('Select'))),
...
const SelectLists = styled__default["default"].div `
  ...
  ul {
    ...
    li {
      ...
      &:hover {
        background-color: ${(props) => props.theme.palette.backgroundOpacity};
      }
    }
  }
`;
