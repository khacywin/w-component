...
var Other = require('./Other-18c06be7.js');
...
const FromGroupWrap = styled__default["default"].div `
  ...
  border-bottom: 1px solid
    ${({ isError, theme }) => isError ? theme.palette.error : theme.palette.border};
  ...
  &.w-select {
    ...
    &:hover,
    &:focus {
      border-color: ${({ isError, theme }) => isError ? theme.palette.error : theme.palette.border};
    }
  }
