...
var index$6 = require('./index-6c814f67.js');
...
var SelectListOption = React__default["default"].memo((props) => {
    ...
    return (React__default["default"].createElement(Dropdown, { full: true, clickOut: !props.isMultiple, className: "w-select-wrap", dropdown_menu: React__default["default"].createElement(SelectLists, { className: "select-options" },
 ...
 * @prop {string} className
 */
var Dropdown = React__default["default"].memo(({ dropdown, dropdown_menu, full, clickOut = true, position, children, className, styleDropdown }) => {
    ...
    return (React__default["default"].createElement(WrapDropdownMenu, { className: className },
        ...
        isDisplay && (React__default["default"].createElement(Dialog, { refParent: refDropdownMenu, ref: refDialog },
            React__default["default"].createElement(DropdownMenu, { className: "dropdown-menu " + (className ? className + "-menu" : ""), style: styleDropdown, full: full, position: position || "left" }, dropdown_menu)))));
});
