...
var index$7 = require('./index-202434c9.js');
...
var index$8 = require('./index-87ea640d.js');
...
require('./Heading-a7087d9f.js');
require('./WrapDialog-2e700248.js');
...
const Checkbox$1 = styled__default["default"].div `
  ...
  & > label:first-of-type {
    ...
    &::after {
      ...
      ${(props) => props.color && colorSVG.colorSVG(props.color)}
    }
    i {
      position: absolute;
      width: 5px;
  ...
  & > label:last-of-type {
    margin-left: 5px;
    ${({ color }) => color && colorSVG.colorSVG(color)};
  }
