...
var index$7 = require('./index-1bd8de3e.js');
var ButtonAction = require('./ButtonAction-f4720ac9.js');
var ButtonNoStyle = require('./ButtonNoStyle-3eedbceb.js');
var React = require('react');
var styled = require('styled-components');
var dayjs_min = require('./dayjs.min-0c332bab.js');
var Year = require('./Year-58c17d16.js');
var _lineOverflow = require('./_lineOverflow-b8a457d2.js');
var Icon = require('./Icon-b6bdc54f.js');
var index$a = require('./index-f0e3963b.js');
...
const Collapse = styled__default["default"].div `
  position: relative;
`;
var index$6 = React__default["default"].memo((props) => {
...
var index$5 = React__default["default"].forwardRef((props, ref) => {
...
const Popover$1 = styled__default["default"].div `
  ...
  ${_lineOverflow.normal};
  ${index$a.transition.popup};
  ${(props) => (props.show ? _lineOverflow.P2.a : _lineOverflow.P0.a)};
  ${(props) => (props.show ? index$a.transition.showPopup : index$a.transition.hiddenPopup)};
...
function DateRange({ fnChange, label, picker = "date", value = {}, defaultValue = {}, }) {
    ...
    return (React__default["default"].createElement(Wrap, { className: "date-range" },
        ...
        React__default["default"].createElement(index$9.DatePicker, { picker: picker, value: value.from, defaultValue: defaultValue.from, fnChange: onChangeFrom, format: format, isRemove: false, disableItem: disableNext }),
        React__default["default"].createElement("span", null,
            React__default["default"].createElement(Icon.Icon, { icon: "i-transfer" })),
        React__default["default"].createElement(index$9.DatePicker, { picker: picker, value: value.to, defaultValue: defaultValue.to, fnChange: onChangeTo, format: format, isRemove: false, disableItem: disablePrevious })));
}
...
var index = /*#__PURE__*/Object.freeze({
  __proto__: null,
  base: index$b.index,
  transition: index$a.index,
  elements: index$b.index$1
});
...
exports.Dropdown = index$8.Dropdown;
exports.Modal = Modal.Modal;
exports.DatePicker = index$9.DatePicker;
exports.Avatar = Avatar;
exports.ButtonLoadMore = ButtonLoadMore;
exports.ChartProcess = ChartProcess;
exports.Checkbox = Checkbox;
exports.Collapse = index$6;
