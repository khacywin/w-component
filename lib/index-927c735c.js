...
var usePositionDropdown = require('./usePositionDropdown-06215ce2.js');
...
var useIntersectionObserver = require('./useIntersectionObserver-3b25895e.js');
...
var index$6 = require('./index-86c4b93c.js');
require('./Other-bd9c73a9.js');
...
function DialogWrap({ children, clickOut = false, position, setIsShow, refParent, setIsShowed, }) {
    ...
    const handleDropdownChange = React.useCallback((list) => {
        if (list[0].boundingClientRec.height) {
            handlePosition();
        }
    }, [handlePosition]);
    useIntersectionObserver.useMutationObservable(refContent.current, handleDropdownChange);
    React.useEffect(() => {
        let _hide;
        /**
...
function DateRange({ fnChange, label, picker = "date", value = {}, defaultValue = {}, }) {
    ...
    return (React__default["default"].createElement(Wrap, { className: "date-range" },
        ...
        React__default["default"].createElement(index$6.DatePicker, { picker: picker, value: value.from, defaultValue: defaultValue.from, fnChange: onChangeFrom, format: format, isRemove: false, position: "left", disableItem: disableNext }),
        React__default["default"].createElement("span", null,
            React__default["default"].createElement(Icon.Icon, { icon: "i-transfer" })),
        React__default["default"].createElement(index$6.DatePicker, { picker: picker, value: value.to, defaultValue: defaultValue.to, fnChange: onChangeTo, format: format, isRemove: false, position: "right", disableItem: disablePrevious })));
}
