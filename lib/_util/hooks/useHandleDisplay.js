    ...
    React.useEffect(() => {
        ...
        function handleClickOutside(e) {
            ...
            if (current) {
                ...
                if (!path.some((item) => current.contains(item.parentNode))) {
                    hide();
                }
            }
        }
        ...
        setTimeout(() => {
            var _a, _b;
            if ((_b = (_a = ref.current) === null || _a === void 0 ? void 0 : _a.parentElement) === null || _b === void 0 ? void 0 : _b.classList.contains('dialog-mark')) {
        ...
        return () => {
            ...
            if ((_b = (_a = ref === null || ref === void 0 ? void 0 : ref.current) === null || _a === void 0 ? void 0 : _a.parentElement) === null || _b === void 0 ? void 0 : _b.classList.contains('dialog-mark')) {
...
module.exports = useHandleDisplay;
