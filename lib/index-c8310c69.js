...
var Dropdown = React__default["default"].memo(({ dropdown, dropdown_menu, full, clickOut = true, position, children, className, styleDropdown, isBaseParent, }) => {
    ...
    const refShow = React.useRef(false);
    ...
    const handleDropdownChange = React.useCallback((entries) => {
    ...
    _util_hooks_useIntersectionObserver(refDropdownMenu.current, handleDropdownChange);
