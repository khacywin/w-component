...
var Calendar = require('components/atoms/Calendar');
var Clock = require('components/atoms/Clock');
...
var index$1 = require('./index-e168d184.js');
...
var Month = require('components/atoms/Calendar/Month');
var Year = require('components/atoms/Calendar/Year');
...
var Month__default = /*#__PURE__*/_interopDefaultLegacy(Month);
var Year__default = /*#__PURE__*/_interopDefaultLegacy(Year);
...
var DateTime = React__default["default"].memo(({ fnChange, format = 'DD MMMM,YYYY', label, name, style, value = '', isRemove = true, defaultValue, disableItem, }) => {
    var _a;
    const id = generatedId__default["default"]('date-picker');
    ...
    return (React__default["default"].createElement(Wrap$1, { ref: refDropdown },
        React__default["default"].createElement(FormGroup__default["default"], { style: style || {}, isFocus: true, label: label, id: id },
            ...
            isRemove && (React__default["default"].createElement(ButtonClose$1, { onClick: onRemove, type: 'button' },
                React__default["default"].createElement(Icon__default["default"], { small: true, icon: 'i-close' }))),
                    ...
                    React__default["default"].createElement(WrapContainer, null,
                        React__default["default"].createElement(Top, null,
                            React__default["default"].createElement("div", null,
                                React__default["default"].createElement(ButtonAction__default["default"], { isActive: tab === 'date', onClick: () => setTab('date') },
                                    React__default["default"].createElement(Icon__default["default"], { icon: 'i-calendar' })),
                                React__default["default"].createElement(ButtonAction__default["default"], { isActive: tab === 'time', onClick: () => setTab('time') },
                                    React__default["default"].createElement(Icon__default["default"], { icon: 'i-time' }))),
                            React__default["default"].createElement("div", null,
                                React__default["default"].createElement(ButtonAction__default["default"], { onClick: () => hide() },
                        ...
                        React__default["default"].createElement("div", null,
                            React__default["default"].createElement(Container, { active: tab === 'date' },
                                React__default["default"].createElement(Calendar__default["default"], { selected: new Date(date), disableItem: disableItem, fnSelected: onChange('date-time') })),
                            React__default["default"].createElement(Container, { active: tab === 'time' },
                                React__default["default"].createElement(Clock__default["default"], { selected: time || date, fnSelected: onChange('time') })))))))));
});
...
const DropdownMenu$1 = styled__default["default"].div `
  background-color: ${(props) => props.theme.palette.backgroundContent};
  display: none;
  padding: 15px;
  position: absolute;
  z-index: -1;
...
function Other({ fnChange, format = 'DD MMMM,YYYY', label, name, picker = 'date-time', style, value = '', isRemove = true, defaultValue, disableItem, }) {
    ...
    const containers = React.useMemo(() => new Map()
        ...
        React__default["default"].createElement(Calendar__default["default"], { selected: val, disableItem: disableItem, fnSelected: onChange('date') })))
        .set('time', React__default["default"].createElement(InputDateSelectorContainer, { show: true },
        React__default["default"].createElement(Clock__default["default"], { selected: time, fnSelected: onChange('time') })))
        .set('year', React__default["default"].createElement(InputDateSelectorContainer, { show: true },
        React__default["default"].createElement(Year__default["default"], { selected: val, disableItem: disableItem, fnSelected: onChange('year') })))
        .set('month', React__default["default"].createElement(InputDateSelectorContainer, { show: true },
        React__default["default"].createElement(Month__default["default"], { selected: new Date(date), disableItem: disableItem, fnSelected: onChange('month') }))), [val, disableItem, onChange, time, date]);
    // Handle value and format data
    // Set state of component with value
    React.useEffect(() => {
        if (!value && !defaultValue)
