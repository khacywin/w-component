...
var index = require('../index-222b36c6.js');
...
function DateRange({ fnChange, label, picker = "date", value = {}, defaultValue = {}, }) {
    ...
    return (React__default["default"].createElement(Wrap, { className: "date-range" },
        ...
        React__default["default"].createElement(index.DatePicker, { picker: picker, value: value.from, defaultValue: defaultValue.from, fnChange: onChangeFrom, format: format, isRemove: false, position: "left", disableItem: disableNext }),
        React__default["default"].createElement("span", null,
            React__default["default"].createElement(Icon.Icon, { icon: "i-transfer" })),
        React__default["default"].createElement(index.DatePicker, { picker: picker, value: value.to, defaultValue: defaultValue.to, fnChange: onChangeTo, format: format, isRemove: false, position: "right", disableItem: disablePrevious })));
}
