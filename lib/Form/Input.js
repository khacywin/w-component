...
var Slider = React__default["default"].memo((props) => {
    ...
    React.useEffect(() => {
        refSliderBox.current.width.baseVal.value;
...
var Input = React__default["default"].memo((_a) => {
    ...
    const inputs = new Map()
        ...
        React__default["default"].createElement(App, { width: 20, height: 20, onChange: fnChange ? onChangeColor : setColor, defaultValue: value || color || "#54478c" }),
        React__default["default"].createElement("input", { type: "hidden", name: name, value: color || value || "#54478c" })));
    return (React__default["default"].createElement(Form__FormGroup["default"], { isInputTitle: isInputTitle, style: style, label: label, isFocus: value || placeholder, id: id, inline: type === "color", error: error }, inputs.get(type)));
});
/** Style */
