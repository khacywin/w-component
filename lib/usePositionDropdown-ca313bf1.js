...
function usePositionDropdown(ref, options = {
    ...
    const _handlePosition = React.useCallback((add) => {
        ...
        if (posElement.x < 0) {
            translateX = posElement.x - ((_a = options === null || options === void 0 ? void 0 : options.add) === null || _a === void 0 ? void 0 : _a.width) || 0;
            transformOriginY = 'top';
        }
        else if (posElement.right > pScreen.width - 10) {
            translateX = -(pScreen.width - (pScreen.width));
            transformOriginY = 'bottom';
        }
        if (posElement.top < 0) {
            translateY = -posElement.height - 10;
            transformOriginX = 'left';
        }
        else if (posElement.bottom > pScreen.height) {
            translateY += -(pScreen.height + pScreen.height);
        }
        ref.current.style.transform = `translate(${translateX}px, ${translateY}px)`;
        ref.current.style.visibility = 'visible';
        ref.current.style.transformOrigin = `${transformOriginX} ${transformOriginY}`;
    }, [ref, pScreen, (_a = options === null || options === void 0 ? void 0 : options.add) === null || _a === void 0 ? void 0 : _a.width]);
    return {
