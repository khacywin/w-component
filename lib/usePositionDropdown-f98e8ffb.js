...
var index = require('./index-25f82d48.js');
...
var Calendar = React__default["default"].memo(({ selected, fnSelected, period = 'date', noSelect = false, disableItem }) => {
        ...
        for (let row = 0; row < 7; row++) {
            for (let col = 0; col < 6; col++) {
                ...
                if (row === 0 && col < firstDay) {
                    ...
                    html.push(React__default["default"].createElement(index.CalendarDate, { className: checkedSelectedDateFollowPeriod(indexPrev, month === 0 ? 11 : month - 1, month === 0 ? year - 1 : year)
                            ? 'selected'
                 ...
                 */
                    ...
                    html.push(React__default["default"].createElement(index.CalendarDate, { className: checkedSelectedDateFollowPeriod(indexNext, month === 11 ? 0 : month + 1, month === 11 ? year + 1 : year)
                            ? 'selected'
                 ...
                 */
                    ...
                    html.push(React__default["default"].createElement(index.CalendarDate, { className: checkedSelectedDateFollowPeriod(index$1, month, year)
                            ? 'selected'
    ...
    return (React__default["default"].createElement(index.CalendarWrap, { noSelect: noSelect },
        React__default["default"].createElement(index.CalendarTop, null,
        ...
        React__default["default"].createElement("tbody", null,
            React__default["default"].createElement(index.CalendarHead, null,
